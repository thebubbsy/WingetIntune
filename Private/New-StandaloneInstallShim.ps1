...
.DESCRIPTION
    ...
    winget path resolution, real Global\_MSIExecute mutex lock detection, process tree monitoring
    to avoid fork-and-exit bootstrapper traps, and safe taskkill termination.
#>
...
.SYNOPSIS
    ...
    Generated by WingetIntune with Process Tree Watchdog & MSI Mutex Protection
#>
[CmdletBinding()]
param()
...
# 2. Wait for Global\_MSIExecute Mutex (Avoid Error 1618 Collisions)
$mutexTimeoutSec = 120
...
# 4. Launch Installer with Process Tree Watchdog (Prevents Fork-and-Exit Trap)
$params = @(
    'install',
    '--exact',
    '--id', $packageId,
