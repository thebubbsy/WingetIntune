...
.SYNOPSIS
    ...
    Generated by WingetIntune with Process Tree Watchdog, Mutex Protection & SYSTEM Profile Prep
#>
[CmdletBinding()]
param()
...
# 3. Wait for Global\_MSIExecute Mutex (Avoid Error 1618 Collisions)
$mutexTimeoutSec = 120
...
# 5. Launch Installer with Process Tree Watchdog (Prevents Fork-and-Exit Trap)
$params = @(
    'install',
    '--exact',
    '--id', $packageId,
